...
type OnboardingChoiceInfoModalProps = {
  visible: boolean;
  onClose: () => void;
  theme: AppTheme;
...
const CONTENT = {
  ...
  body: 'Pick the option that matches your situation right now.',
  rows: [
    {
      icon: 'shield-checkmark-outline' as const,
      color: (theme: AppTheme) => theme.colors.accent,
      text: 'Set up protection creates a new protected profile and walks through full setup.',
    },
    {
      icon: 'key-outline' as const,
      color: (theme: AppTheme) => theme.colors.success,
      text: 'I have an invite code joins an existing family or facility setup.',
    },
    {
      icon: 'people-outline' as const,
      color: (theme: AppTheme) => theme.colors.textMuted,
      text: 'You can invite more family members later in the setup flow.',
    },
  ],
  buttonLabel: 'Got it',
};

export default function OnboardingChoiceInfoModal({
  visible,
  onClose,
  theme,
  mode,
}: OnboardingChoiceInfoModalProps) {
